...
namespace Xero.DotNet.OAuth2.Api
{
    ...
    public partial class BankFeedsApi : IBankFeedsApi
    {
        ...
        {
             Xero.DotNet.OAuth2.Client.ApiResponse<FeedConnections> localVarResponse = await CreateFeedConnectionsAsyncWithHttpInfo(accessToken, xeroTenantId, feedConnections, cancellationToken);
        ...
        /// <param name="cancellationToken">Cancellation token enables cancellation between threads. Defaults to CancellationToken.None</param>
        /// <returns>Task of ApiResponse (FeedConnections)</returns>
        public async System.Threading.Tasks.Task<Xero.DotNet.OAuth2.Client.ApiResponse<FeedConnections>> CreateFeedConnectionsAsyncWithHttpInfo (string accessToken, string xeroTenantId, FeedConnections feedConnections, CancellationToken cancellationToken = default)
        {
        ...
        {
             Xero.DotNet.OAuth2.Client.ApiResponse<Statements> localVarResponse = await CreateStatementsAsyncWithHttpInfo(accessToken, xeroTenantId, statements, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation token enables cancellation between threads. Defaults to CancellationToken.None</param>
        /// <returns>Task of ApiResponse (Statements)</returns>
        public async System.Threading.Tasks.Task<Xero.DotNet.OAuth2.Client.ApiResponse<Statements>> CreateStatementsAsyncWithHttpInfo (string accessToken, string xeroTenantId, Statements statements = null, CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'xeroTenantId' is set
            if (xeroTenantId == null)
        ...
        {
             Xero.DotNet.OAuth2.Client.ApiResponse<FeedConnections> localVarResponse = await DeleteFeedConnectionsAsyncWithHttpInfo(accessToken, xeroTenantId, feedConnections, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation token enables cancellation between threads. Defaults to CancellationToken.None</param>
        /// <returns>Task of ApiResponse (FeedConnections)</returns>
        public async System.Threading.Tasks.Task<Xero.DotNet.OAuth2.Client.ApiResponse<FeedConnections>> DeleteFeedConnectionsAsyncWithHttpInfo (string accessToken, string xeroTenantId, FeedConnections feedConnections, CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'xeroTenantId' is set
            if (xeroTenantId == null)
