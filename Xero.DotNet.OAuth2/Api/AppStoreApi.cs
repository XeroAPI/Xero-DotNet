...
namespace Xero.DotNet.OAuth2.Api
{
    ...
    public partial class AppStoreApi : IAppStoreApi
    {
        ...
        {
             Xero.DotNet.OAuth2.Client.ApiResponse<UsageRecord> localVarResponse = await PostUsageRecordsAsyncWithHttpInfo(accessToken, subscriptionId, subscriptionItemId, createUsageRecord, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation token enables cancellation between threads. Defaults to CancellationToken.None</param>
        /// <returns>Task of ApiResponse (UsageRecord)</returns>
        public async System.Threading.Tasks.Task<Xero.DotNet.OAuth2.Client.ApiResponse<UsageRecord>> PostUsageRecordsAsyncWithHttpInfo (string accessToken, Guid subscriptionId, Guid subscriptionItemId, CreateUsageRecord createUsageRecord, CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'subscriptionId' is set
            if (subscriptionId == null)
        ...
        {
             Xero.DotNet.OAuth2.Client.ApiResponse<UsageRecord> localVarResponse = await PutUsageRecordsAsyncWithHttpInfo(accessToken, subscriptionId, subscriptionItemId, usageRecordId, updateUsageRecord, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation token enables cancellation between threads. Defaults to CancellationToken.None</param>
        /// <returns>Task of ApiResponse (UsageRecord)</returns>
        public async System.Threading.Tasks.Task<Xero.DotNet.OAuth2.Client.ApiResponse<UsageRecord>> PutUsageRecordsAsyncWithHttpInfo (string accessToken, Guid subscriptionId, Guid subscriptionItemId, Guid usageRecordId, UpdateUsageRecord updateUsageRecord, CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'subscriptionId' is set
            if (subscriptionId == null)
